...
type Config struct {
	...
	GeminiAPIKey         string        `hcl:"gemini_api_key" env:"GEMINI_API_KEY" default:""`
	GeminiPrompt         string        `hcl:"gemini_prompt" env:"GEMINI_PROMPT"`
	GeminiModel          string        `hcl:"gemini_model" env:"GEMINI_MODEL" default:"gemini-pro"`
}
...
func Get() Config {
	once.Do(func() {
		...
		if err := loader.Load(); err != nil {
			log.Printf("[Error] failed to load the config: %v", err)
		}
	})
